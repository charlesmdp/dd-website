...
def native_home():
 ...
 for block in [brandbar,go,modes,operations,plans,trust,faq,learn,footer(),f'<script defer src="/assets/site.js?v={ASSET_VERSION}"></script>']:
